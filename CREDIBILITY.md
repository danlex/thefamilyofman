...
- **Peer-reviewed journals**: *History of Photography*, *October*, *Art Bulletin*, *Aperture* (editorial content), *Afterimage*, *Camera Obscura* (Duke UP), *Screen* (Oxford UP), *Visual Studies* (Routledge), *Art Journal* (CAA / Routledge), *Public Culture* (Duke UP), *Oxford Art Journal* (OUP), *Parachute* (Montréal art-theory journal, 1975–2009)
