...
{% include image.html
   ...
   alt="Clervaux Castle, Luxembourg — UNESCO Memory of the World host since 2003"
   caption="Clervaux Castle, Luxembourg — home of the UNESCO Memory of the World–inscribed Family of Man collection."
...
<nav class="page-toc" aria-label="Page contents">
  ...
  <ol>
    <li><a href="#the-memory-of-the-world-programme">The Memory of the World programme</a></li>
    <li><a href="#the-2003-inscription">The 2003 inscription</a></li>
    <li><a href="#what-the-register-says">What the register says</a></li>
    <li><a href="#the-canonised-figures">The canonised figures</a></li>
    <li><a href="#what-inscription-does-and-doesnt-entail">What inscription does and doesn't entail</a></li>
    <li><a href="#1992-1994-pre-inscription-touring">1992–1994 pre-inscription touring</a></li>
    <li><a href="#anniversaries">Anniversaries</a></li>
    <li><a href="#significance">Significance</a></li>
  </ol>
</nav>

In **2003**, the Clervaux collection of *The Family of Man* was inscribed on **UNESCO's Memory of the World International Register**.[^1] This page covers the inscription itself: the framework under which it was made, the language the register uses to justify it, and what inscription does and does not change about how the collection sits in the world. The Luxembourg institutional history — Steichen's donation request, the Clervaux installation from 1994, the 2010–2013 restoration — is on the [Clervaux page]({{ '/clervaux/' | relative_url }}) and is not repeated here.
...
The submitting state, Luxembourg, is consistent with the institutional context: the collection had been in Luxembourg's custody since the 1964–1966 U.S. Government donation and, from 1994, under the permanent stewardship of the Centre national de l'audiovisuel at Clervaux Castle (see the [Clervaux page]({{ '/clervaux/' | relative_url }}) for that history). The nomination was prepared and submitted approximately nine years after the 1994 permanent installation opened.
...
The last formulation is notable: it acknowledges the Cold War political context that has driven the show's [critical reception]({{ '/reception/' | relative_url }}) since Roland Barthes's *Mythologies* (1957) — but it frames that context as part of the exhibition's significance rather than as a limitation. UNESCO does not adjudicate between Steichen's universalist humanism and Barthes's critique; it inscribes the artefact and lets the scholarship continue.
...
The first three are the same numbers MoMA's 1955 master checklist anchors and that the [Photographs index]({{ '/photographs/' | relative_url }}) is built around. The fourth — *"32 themes"* — is the count UNESCO carries.[^1] The CNA Luxembourg education portal publishes a different count: *"37 themes like a photo-essay about human development and cycles of life."*[^3] Both counts are Tier-1-adjacent institutional claims, established at different moments by different institutions for different audiences. This wiki records the discrepancy on the [Sections index]({{ '/sections/' | relative_url }}) and does not adjudicate.
...
The UNESCO register entry briefly notes that *"during 1992 and 1993–1994, restored versions traveled internationally, including stops in Toulouse, Tokyo, and Hiroshima."*[^1] This pre-inscription circulation — restored prints touring internationally in the years immediately before the 1994 Clervaux permanent installation opened — is a small-but-important addition to the [world tour]({{ '/tour/' | relative_url }}) timeline, which is otherwise dominated by the 1955–1962 USIA-sponsored circulation. It also speaks to the collection's already-international visibility at the moment of the 2002 nomination.

{% include image.html
   src="/assets/images/clervaux-2015-rg72-interior.jpg"
   alt="Family of Man interior at Clervaux"
   caption="Interior of the inscribed installation, photographed in 2015 — twelve years after the 2003 inscription and two years after the 2010–2013 restoration."
...
For the specific collection at Clervaux, the practical significance of inscription is threefold. First, it formally validates Luxembourg's role as custodian of a globally-significant documentary heritage — an argument that supports continued public investment in CNA stewardship. Second, it anchors the collection within an international heritage infrastructure, making it discoverable and citable across languages and jurisdictions. Third, the inscription year (2003) **predates the 2010–2013 restoration campaign by seven years**: the restoration that today's visitor sees was therefore carried out on an already-inscribed collection, under the visibility and reputational weight that inscription confers. See [Clervaux]({{ '/clervaux/' | relative_url }}) for that restoration's detail.
...
<div class="perspective-note">
  ...
  This page is told mostly through UNESCO's own institutional voice — the register entry and the programme's self-description. UNESCO is one of several lenses on this exhibition, alongside MoMA's 1955 record (see <a href="{{ '/exhibition/' | relative_url }}">/exhibition/</a>), the CNA's curatorial framing at Clervaux (see <a href="{{ '/clervaux/' | relative_url }}">/clervaux/</a>), and the critical reception thread (see <a href="{{ '/reception/' | relative_url }}">/reception/</a>). UNESCO does not adjudicate between Steichen's humanist argument and Barthes's critique of it; the register acknowledges the Cold War context but does not take sides. Critical scholarship on the Memory of the World programme itself — its inscription criteria, its handling of contested heritage, and the political dynamics of nominations — exists but is not engaged on this page; the framing here treats UNESCO's framework descriptively, not evaluatively. The two nomination-form PDFs that would carry the formal 2002 justification are linked from the register page but were not fetched in this round; their content is not quoted here. Anniversary events for 2013 and 2023 are openly flagged as not yet researched. Full provenance and an open-tasks list are in <a href="https://github.com/danlex/thefamilyofman/blob/main/research/unesco.md"><code>research/unesco.md</code></a>.
</div>

[^1]: UNESCO. *Family of Man*, Memory of the World International Register, inscribed 2003. [unesco.org/en/memory-world/family-man](https://www.unesco.org/en/memory-world/family-man) — re-verified 2026-04-29. `src-unesco-mow-2003`. Anchors: registration year 2003, submission year 2002, submitting state Luxembourg, region Europe and North America, document type Books; the 503/273/68 composition figure; the *"32 themes"* count; the *"greatest photographic enterprise"*, *"very personal approach,"* *"courageous and provocative,"* and *"memory of an entire era, that of the Cold War and McCarthyism"* justification quotations; the 1992 / 1993–1994 pre-inscription touring note (Toulouse, Tokyo, Hiroshima); URLs for the English and French nomination form PDFs. PDFs themselves were not fetched in this round.
[^2]: UNESCO. *Memory of the World Programme* — overview, About, and Register landing pages. [unesco.org/en/memory-world](https://www.unesco.org/en/memory-world) ; [/about](https://www.unesco.org/en/memory-world/about) ; [/register](https://www.unesco.org/en/memory-world/register) — fetched 2026-04-29. `src-unesco-mow-programme`. Anchors: 1992 founding; the *"world's documentary heritage belongs to all"* aspiration; the International Advisory Committee with 14 members appointed by the Director-General; the IAC + Executive Board two-step inscription pathway; the *"world significance and outstanding universal value"* selection criterion; the 2015 UNESCO Recommendation Concerning Preservation of, and Access to, Documentary Heritage; the 570-inscriptions running total (current at 2026-04-29 fetch).
[^3]: Centre national de l'audiovisuel (CNA), Luxembourg. "The Family of Man, the book of humanity" (educational portal). `src-cna-education`. The *"37 themes like a photo-essay about human development and cycles of life"* count is verbatim from this source.
