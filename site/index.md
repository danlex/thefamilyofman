...
<section class="wrap-wide" style="padding: 0 1.25rem; margin-top: 4rem;">
  ...
  <div class="action-row">
    ...
    <a class="action-card" href="https://github.com/danlex/thefamilyofman/tree/main/research/photographers" rel="noopener">
      ...
      <h3>+20 anchored bios across batches 03–08 (PRs #125, #128, #171, #174, #191)</h3>
      <p>Batch 08 (PR #191) added W. Eugene Smith, David Seymour / Chim, Homer Page, and Gjon Mili — with one major discovery: <strong>Homer Page is a top-5 contributor at 10 plates</strong>, previously not in the CSV. (Smith's <em>A Walk to Paradise Garden</em> at plate #503 is the closing image of the entire 503-plate exhibition; Seymour co-founded Magnum with Capa, Cartier-Bresson, and Rodger; Mili pioneered strobe photography.) Page's bio rests on a Wikipedia pointer alone (ICP 404, MoMA 403) and is explicitly thin-anchored pending a fetch of Davis 2009 or the Nelson-Atkins Hallmark Collection catalog. The 0-plates strict-grep filter has now caught Walker Evans, Arthur Rothstein, Marc Riboud, Eve Arnold, Inge Morath across four consecutive batches — a productive forcing function.</p>
    </a>
