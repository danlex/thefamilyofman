...
<section class="wrap-wide" style="padding: 0 1.25rem; margin-top: 4rem;">
  ...
  <div class="action-row">
    ...
    <a class="action-card" href="https://github.com/danlex/thefamilyofman/blob/main/research/world-tour.md" rel="noopener">
      ...
      <h3>Tokyo + Belgrade + Warsaw anchored (PRs #189 + #192)</h3>
      <p>Three new Tier-1/2 tour anchors in 48 hours. <strong>Tokyo Takashimaya 21 March 1956</strong> (PR #189) — Tier-2 with three independent attestations (Takenaka 2020, O'Brian 2008, SFMOMA Phillips 2022). <strong>Belgrade Cvijeta Zuzorić Art Pavilion, 26 January – 22 February 1957</strong> (PR #192) — Tier-1 (Museum of Yugoslavia + Belgrade Photo Month). <strong>Warsaw Sale Redutowe / National Theatre, autumn 1959</strong> (PR #192) — anchored at primary-archival level via three Eustachy Kossakowski negatives (items 8377–8379) in the Museum of Modern Art in Warsaw archive — first contemporaneous photographic record of any Eastern-bloc venue beyond Moscow. Negative findings (Prague / Bucharest / Sofia / Budapest in no fetched tour-list) recorded as access-barrier; schema-validator extended for Polish/Serbian/Czech sources.</p>
    </a>
    <a class="action-card" href="https://github.com/danlex/thefamilyofman/tree/main/research/photographers" rel="noopener">
      ...
      <h3>+24 anchored bios across batches 03–09 (PRs #125, #128, #171, #174, #191, #195)</h3>
      <p>Batch 09 (PR #195) added the European-modernist / Bauhaus-heritage slate: <strong>August Sander</strong> (3 plates, Weimar typological portraits — the only pre-1933 portrait corpus represented at this scale in FoM), <strong>Andreas Feininger</strong> (2 plates, Bauhaus / OWI / LIFE), <strong>Eddy van der Elsken</strong> (1 plate, Dutch Adult Play, anchored via Eva Besnyo's testimony of a Steichen-1953 meeting at Paul Huf's Amsterdam studio per Wikipedia footnote 13 citing Gresh 2005), <strong>Herbert List</strong> (1 plate, German classical-surrealism, Magnum contributor from 1951 via Capa). The 0-plates filter widens further: Moholy-Nagy and Steinert join the no-plates list (now <strong>7 photographers</strong> across batches 03–09 caught by strict-grep before they could be bio'd). Plus a new portrait of <a href="https://github.com/danlex/thefamilyofman/blob/main/site/assets/images/miller-1945-uss-ticonderoga.license.json"><strong>Wayne Miller</strong></a> (PR #197): NARA Steichen-Navy-unit photograph, 1945, PD-USGov — the first portrait of one of the curatorial team to land in <code>site/assets/images/</code>. Issues #165 (Rudolph) and #167 (Szarkowski) remain open.</p>
    </a>
