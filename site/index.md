...
<section class="wrap-wide" style="padding: 0 1.25rem; margin-top: 4rem;">
  ...
  <div class="action-row">
    ...
    <a class="action-card" href="https://github.com/danlex/thefamilyofman/blob/main/research/world-tour.md" rel="noopener">
      ...
      <h3>World-tour Tier-1/2 venues now at 8/9 (PRs #189, #192, #199)</h3>
      <p>Five new venue anchors in 72 hours: <strong>Tokyo Takashimaya 21 March 1956</strong> (Tier-2, three independent attestations); <strong>Belgrade Cvijeta Zuzorić Art Pavilion, 26 Jan – 22 Feb 1957</strong> (Tier-1); <strong>Warsaw Sale Redutowe</strong> (autumn 1959, primary-archival via three Kossakowski negatives in MoMA Warsaw); <strong>Mexico City, Calle Lafragua #4, 28 Oct – 13 Nov 1955, 12,500+ attendance</strong> (Tier-2 via Córdova 2013, Centro de la Imagen / Secretaría de Cultura — first per-venue attendance figure in the project, attributed to MoMA records via the U.S. Embassy Cultural Affairs Office); <strong>Caracas, Universidad Central de Venezuela, 5–30 July 1957</strong> (Tier-3 via Artishock 2022, MoMA-Archives-attributed Copy-4 itinerary). Plus a Bogotá <em>shipped-but-not-displayed</em> finding (23 crates in storage during the political fall of Rojas Pinilla, May 1957). Negative findings honestly recorded for Buenos Aires / São Paulo / Lima / Prague / Bucharest / Sofia / Budapest. <strong>The "9M / 91 cities / 37 countries" canonical formula has now been documented as a six-source disagreement</strong> (Turner 7.5M/37, O'Brian 9M/61, CNA ~10M/160, Polish Wikipedia 9M/91/38, Córdova 9M/69, Takenaka 48 countries) — none reconcile.</p>
    </a>
