...
- ***Mythologies*** (1957): contains the essay "La grande famille des hommes" critiquing *The Family of Man* exhibition (cross-referenced from `src-barthes-1957-mythologies` in repo).

## Notes

- Per `CREDIBILITY.md` Wikipedia is treated as a pointer source — the 1915 Cherbourg birth and 1980 Paris death should be promoted to Tier 1 / Tier 2 against a Barthes biography (Samoyault 2015 is the canonical recent biography in English) before being cited as authoritative.
- Cross-references: `src-barthes-1957-mythologies` (in repo, Tier 2 anchor for the *Family of Man* critique itself), `src-barthes-1957-mythologies-fr` (in repo, Tier 2 anchor for the original French text).
