...
Ernst Haas contributes one plate to Section 26 Learning (photo-0329, checklist #339, noted in `data/photographs.csv` as carrying a Magnum / VOGUE credit) — one of two Haas plates in sub-sections adjacent to this cluster (photo-0235 in Section 21 Dance and photo-0329 here). These two plates represent the Haas presence in the mid-flow social and learning arc of the exhibition.
