---
id: src-ane-moscow-1959
title: "American National Exhibition, Moscow (Sokolniki Park, 1959)"
author: "United States Information Agency (USIA)"
year: 1959
type: archive
publisher: "United States Information Agency; records at National Archives Record Group 306"
url: "https://en.wikipedia.org/wiki/American_National_Exhibition"
accessed: 2026-04-30
tier: 1
language: en
tags: [world-tour, moscow, usia, cold-war, american-national-exhibition, sokolniki, nixon-khrushchev, kitchen-debate]
verified: false  # Tier 1 applies to the USIA archival event/institution itself (NARA RG 306). Wikipedia URL above is a pointer placeholder only — primary archival record NOT consulted this round. Promote to verified:true only after NARA RG 306 access.
---
...
- Wikipedia is used as a pointer only, per `CREDIBILITY.md` policy. The actual primary sources for this entry are NARA RG 306 (USIA records) and MoMA International Program records, neither of which was consulted this round.
- The Steichen quote 'the high spot of the project' circulates in secondary literature (including search-result excerpts for this session) but was NOT traced to a primary source in this round.
...
- The Moscow 1959 stop is described in the Sandeen 1995 book (`src-sandeen-1995`) in the chapter 'The Family of Man in Moscow'; body text of that chapter was NOT accessed in any session to date.
