---
id: src-c2dh-fomleg
title: "Tracing the Legacy of Edward Steichen: A Glocal Approach to the International Reception and National Heritagisation of the 'Family of Man' Exhibition (FoMLEG)"
authors: ["Fickers, Andreas (PI)", "Ewert, Claude", "Sanchez Gonzalez, Emilia"]
year: 2024
type: website
publisher: "Luxembourg Centre for Contemporary and Digital History (C²DH), University of Luxembourg"
url: "https://www.uni.lu/c2dh-en/research-projects/fomleg/"
accessed: 2026-04-30
tier: 2
language: en
tags: [fomleg, scholarship, world-tour, cold-war, heritagisation, luxembourg, cna, digital-history, reception]
---
...
- Project full title (search result, 2026-04-30): 'Tracing the legacy of Edward Steichen: A glocal approach to the international reception and national heritagisation of the "Family of Man" exhibition (FoMLEG).'
- Research scope (search result, 2026-04-30): 'investigates the itinerancy of the landmark show during its global tour (1955-1963).'
- Principal investigator and team (search result, 2026-04-30): 'led by Andreas FICKERS as PI, with Claude EWERT as a project member, and Emilia SANCHEZ GONZALEZ as another project member.'
- Claude Ewert's focus (search result, 2026-04-30): 'the exhibition's reception in Luxembourg, which was initially quite frosty when the Luxembourgish authorities told Steichen that photography is no art.'
- Archival phase (search result, 2026-04-30): 'January 2025 kicked off the on-site archival research phase of the project and sent researchers on a trip to three core locations outside of Luxembourg: The George Eastman Museum, the Museum of Modern Art (MoMA), and the U.S. National Archives.'
- Expected outputs (search result, 2026-04-30): 'a graphic novel will offer a research-based narrative about Steichen and the emergence of FoM as one of the most iconic photograph exhibitions of the 20th century.'

## Notes

- The project page URL (https://www.uni.lu/c2dh-en/research-projects/fomleg/) was returned in multiple search results (2026-04-30) but NOT directly fetched this round — Chrome navigation and WebFetch were both denied by the permission system. All content above derives from search-engine excerpts returned in this session (2026-04-30) and from a secondary C²DH news article also returned in search (https://www.uni.lu/c2dh-en/news/the-family-of-man-lasting-legacy/).
- Verified: false — project page not directly opened this round. Metadata carries from search results only.
