...
│  ├─ 488 rows seeded across 15 catalog batches (PRs #4, #7, #11, #16, #49, #53, #60, #65, #67, #69, #71, #73, #75, #77, #79) &mdash; <i>see <a href="{{ '/photographs/' | relative_url }}">/photographs/</a></i>
...
- **488 of 503 plates seeded** as of PR #79, via 15 catalog batches: PRs #4 (47), #7 (47), #11 (98), #16 (25), #49 (24), #53 (24), #60 (25), #65 (25), #67 (24), #69 (23), #71 (24), #73 (25), #75 (25), #77 (25), #79 (27); sum = 488 (verified by `git show <commit> -- data/photographs.csv | grep -c '^+photo-'` on each merge commit). The 15-row gap (488 vs 503) reflects 16 documented missing-checklist-numbers + the Eugene Harris #11A-#11F single-row recurring-plate treatment + the series-as-one-row treatment for plates like Ruth Orkin's #73 a-f, **minus** 1 letter-suffix supplement (#404A) added as its own row at photo-0390. **A precise gap-reconciliation audit is a flagged follow-up cleanup item.**
