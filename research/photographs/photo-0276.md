...
| Section | sec-relationships-community (Section 24, Ring Around the Rosy) |
...
Plate #287 (18 × 14 1/2 cm) is a small print. Section 24, Ring Around the Rosy, contains a variety of print sizes from 18 × 12 cm (Francois Tuefferd, plate #270) to 18 × 28 cm (Hermann Claasen, plate #277); plate #287 is at the smaller end of the section's range.

David Seymour's biographical dates: born 20 November 1911, Warsaw; died 10 November 1956, El Qantara, Egypt. He did not live to see the final year of the exhibition's international circulation. His death occurred during the Suez Crisis — killed by machine-gun fire — a death whose violent political context stands in counterpoint to the exhibition's universalist-humanist register. The ICP institutional about-page (`src-icp-1966-concerned-photography-fund-institutional`, Tier-3, in-repo, read this session) and the Magnum directory (`src-magnum-photographer-bios`, Tier-3, in-repo, read this session) both confirm his central role in the humanist-documentary tradition. The Magnum individual page for Seymour (`https://www.magnumphotos.com/photographer/david-chim-seymour/`) returned 404 when attempted this round; no content from that page was retrieved.

Whether this print entered MoMA's permanent collection or was returned after the circulating tour is not recorded in any source fetched this round. Whether the print is among the Clervaux Castle holdings was not verified this round.
...
- The Magnum Photos individual page for Seymour returned 404 this round. The ICP archive for Seymour (`https://www.icp.org/browse/archive/constituents/david-seymour`) was not fetched this round.
