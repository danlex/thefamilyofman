# Photograph: photo-0097

| Field | Value |
|---|---|
| ID | photo-0097 |
| Title | Untitled (in the 1955 checklist) |
| Photographer | Homer Page (see `data/photographers.csv`) |
| Year | (not recorded in checklist; consistent with Page's Guggenheim documentation year 1949–1950) |
| Country of origin | USA |
| Section | sec-family-children (Section 11, Children B) |
| MoMA object ID | (not filled — MoMA collection page returned 403 this round) |
| On display at Clervaux | unknown |
| Sources | `src-moma-exh-0569-master-checklist`; `src-wikipedia-homer-page-pointer` |

## Provenance

The MoMA Master Checklist (`src-moma-exh-0569-master-checklist`, Tier-1, in-repo, fetched 2026-04-19) records plate #103 as:

> *"U.S.A. — Homer Page, American — 14 × 16 1/2"*

This is the first of ten Page plates listed in the checklist (the in-repo source `src-wikipedia-homer-page-pointer`, verified 2026-05-09, records him as having ten FoM plates total per a strict-match grep against `data/photographs.csv`). The checklist does not record a title or date for this plate.

Section 11 is titled "Children (B)" in the MoMA Master Checklist. The checklist places plate #103 within a contiguous run of Children-B plates, which the `data/sections.csv` entry (in-repo, read this session) maps to the `sec-family-children` cluster.

No source fetched this round attests the specific date, location, or subject identity of this plate. Page's best-documented work is his 1949–1950 Guggenheim-year New York street photography; the majority of his checklist plates are listed as U.S.A. and may fall in this period, but plate-level date verification is not available from any source consulted this round.

The print dimensions (14 × 16 1/2 cm) are recorded in the MoMA Master Checklist PDF. Whether the print is held at Clervaux Castle or in any other institutional collection is not attested in any source fetched this round.
