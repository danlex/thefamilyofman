...
| Sources | `src-moma-exh-0569-master-checklist`; `src-icp-cartier-bresson-archive`; `src-magnum-photographer-bios`; `src-moma-archives-highlights-1955`; `src-barthes-1957` |

## Provenance

The MoMA Master Checklist (`src-moma-exh-0569-master-checklist`, Tier-1, in-repo, read this session) records plate #31 as:

> *"31 — France — Henri Cartier-Bresson, Magnum, French"*

The print dimension (18 × 12 1/2 cm) is recorded in `data/photographs.csv` for this row; the checklist line above does not carry print dimensions.

Plate #31 is one of eleven Cartier-Bresson plates in the exhibition — the largest single-photographer count among Magnum members in the show. This is the first Cartier-Bresson plate in the exhibition's numerical sequence. The checklist credits the image to Magnum Photos — the cooperative agency Cartier-Bresson co-founded in 1947, per `src-icp-cartier-bresson-archive` (Tier-1, in-repo, read this session), along with Robert Capa, David "Chim" Seymour, and George Rodger.

No date is given in the checklist for this plate. The ICP Cartier-Bresson archive page (`src-icp-cartier-bresson-archive`, read this session) states that Cartier-Bresson "began photographing in 1931 and purchased a Leica in 1933" — confirming that any French subject matter in the exhibition could date across a wide range of the 1930s–1950s, and no specific year has been verified for plate #31 from any source consulted in this round.
