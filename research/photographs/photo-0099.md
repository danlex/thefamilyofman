# Photograph: photo-0099

| Field | Value |
|---|---|
| ID | photo-0099 |
| Title | Untitled (in the 1955 checklist) |
| Photographer | W. Eugene Smith (see `data/photographers.csv`) |
...
| Sources | `src-moma-exh-0569-master-checklist`; `src-icp-w-eugene-smith-archive`; `src-magnum-w-eugene-smith`; `src-moma-archives-highlights-1955` |

## Provenance

The MoMA Master Checklist (`src-moma-exh-0569-master-checklist`, Tier-1, in-repo, fetched 2026-04-19) records plate #105 as:

> *"U.S.A. — W. Eugene Smith, American — 20 × 15 1/2"*

This is one of four Smith plates in *The Family of Man* (photo-0099, photo-0333, photo-0367, and photo-0488 — the last identified as the closing image of the exhibition per `src-moma-archives-highlights-1955`, Tier-1, in-repo). The checklist does not record a title or date for this plate.
...
The print dimensions (20 × 15 1/2 cm) are recorded in the MoMA Master Checklist PDF. No current location of the print is attested in any source fetched this round.

**Relationship to "A Walk to Paradise Garden":** the MoMA archives-highlights page (`src-moma-archives-highlights-1955`) identifies Smith's *A Walk to Paradise Garden* (1946) as the closing image of the exhibition — that plate is `photo-0488` at checklist #503, separately documented. The CSV notes for photo-0099 record: "Smith's 'A Walk to Paradise Garden,' 1946, famously closes the exhibition per MoMA archive-highlights; whether this plate is that image is not stated on the checklist itself and is not resolved here." This plate (checklist #105, Section 11 Children B) is distinct from the closing plate (#503).
