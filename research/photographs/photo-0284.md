# Photograph: photo-0284

| Field | Value |
|---|---|
| ID | photo-0284 |
| Title | Untitled (no title in the 1955 checklist) |
| Photographer | Alfred Eisenstaedt (see `data/photographers.csv`) |
...
| Sources | `src-moma-exh-0569-master-checklist`; `src-icp-eisenstaedt-archive`; `src-life-archive-eisenstaedt-bio`; `src-wikipedia-eisenstaedt-pointer`; `src-moma-archives-highlights-1955`; `src-barthes-1957` |
...
The print dimensions (20 × 15 3/4 cm) are drawn from the `data/photographs.csv` notes for this row. The checklist carries a double credit: LIFE (publication) and "American" (nationality per checklist). This is consistent with Eisenstaedt's status as a LIFE staff photographer from 1936 onward.

The `data/photographers.csv` entry for Eisenstaedt confirms this credit pattern: the ICP archive page (`src-icp-eisenstaedt-archive`, Tier-1, in-repo, read this session) states verbatim that "In 1936, Henry Luce hired him, along with Margaret Bourke-White, Peter Stackpole, and Thomas McAvoy as one of four staff photographers for the new LIFE magazine." The LIFE archive page (`src-life-archive-eisenstaedt-bio`, Tier-3, in-repo, read this session) corroborates: Eisenstaedt's birth and death dates are given as "1898–1995."

Plate #295 is the third of seven Eisenstaedt plates in the exhibition. The seven plates (count verified by grep of `data/photographs.csv` this session; confirmed by `src-icp-eisenstaedt-archive`) are: plate #72 (photo-0068, Children A, USA), plate #111 (photo-0105, Fathers and Sons, USA), this plate #295 (photo-0284, Relationships, USA), plate #335 (photo-0324, Learning, Czechoslovakia), plate #338 (photo-0326, Learning, USA), plate #339 (photo-0327, Learning, USA), and plate #458 (photo-0443, later sequence, USA). Six of the seven plates are set in the USA; only plate #335 (Czechoslovakia) steps outside the United States.

Alfred Eisenstaedt (6 December 1898 – 23 August 1995; birth/death day-month tokens from `src-wikipedia-eisenstaedt-pointer`, pointer-tier; year tokens confirmed at Tier-1 by `src-icp-eisenstaedt-archive`, both read this session). Born in Dirschau (now Tczew, Poland — at the time West Prussia, German Empire). The ICP page states verbatim: "Born in Dirschau (now Poland), Alfred Eisenstaedt studied at the University of Berlin and served in the German army during World War I." He arrived in the United States in 1935.
