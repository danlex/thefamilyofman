# Photograph: photo-0147

| Field | Value |
|---|---|
| ID | photo-0147 |
| Title | Untitled (in the 1955 checklist) |
| Photographer | Ernst Haas (see `data/photographers.csv`) |
| Year | (not recorded in checklist) |
| Country of origin | USA |
| Section | sec-work (Section 15, Work A) |
| MoMA object ID | (not filled — MoMA collection page not fetched this round) |
| On display at Clervaux | unknown |
| Sources | `src-moma-exh-0569-master-checklist`; `src-icp-ernst-haas-archive`; `src-haas-estate-biography` |

## Provenance

The MoMA Master Checklist (`src-moma-exh-0569-master-checklist`, Tier-1, in-repo, fetched 2026-04-19) records plate #154 as:

> *"U.S.A. — Ernst Haas, Magnum, ARGOSY, Austrian — 28 × 20 1/4"*

This is the second of six Haas plates in *The Family of Man* per strict-match grep against `data/photographs.csv` (plates: photo-0021, photo-0147, photo-0235, photo-0287, photo-0329, photo-0437). The checklist records Haas's agency as Magnum and his publication credit as ARGOSY — identifying the image as one sold through Magnum to the American general-interest magazine *Argosy*. The checklist does not record a title or date for this plate.

The nationality recorded in the checklist is "Austrian" — consistent with Haas's birth in Vienna. The ICP archive page (`src-icp-ernst-haas-archive`, Tier-1, in-repo, verified 2026-05-09) records him as "American" (reflecting his naturalized citizenship following his 1951 move to the United States), while the Haas Estate biography (`src-haas-estate-biography`, Tier-1, in-repo, verified 2026-05-09) writes "Haas was born in Vienna in 1921" without assigning a nationality string. The MoMA checklist's "Austrian" reflects birth-country attribution as used by the MoMA curatorial staff in 1955.

Per the Haas Estate biography (`src-haas-estate-biography`, Tier-1, in-repo, verified 2026-05-09 from `https://ernst-haas.com/biography/`; verbatim excerpt recorded in the in-repo source file): "Haas moved to the United States in 1951 and soon after, began experimenting with Kodachrome color film." The plate at #154 is set in the U.S.A. and therefore dates from 1951 or later; the checklist publication credit of ARGOSY narrows the date further to the period when Haas was working for that publication, but the specific assignment date is not established in any source fetched this round.

Section 15 is titled "Work (A)" in the MoMA Master Checklist. The `data/sections.csv` entry (in-repo, read this session) maps Section 15 to the `sec-work` cluster.
