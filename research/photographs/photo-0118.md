# Photograph: photo-0118

| Field | Value |
|---|---|
| ID | photo-0118 |
| Title | Untitled (no title in the 1955 checklist) |
| Photographer | Robert Capa (see `data/photographers.csv`) |
| Year | (not recorded in checklist; not filled) |
| Country of origin | USSR |
| Section | sec-work (Section 14 Land) |
| MoMA object ID | (MoMA collection page not fetched this round) |
| On display at Clervaux | unknown |
| Sources | `src-moma-exh-0569-master-checklist`; `src-icp-capa-archive`; `src-nyt-1954-capa-obit`; `src-moma-archives-highlights-1955`; `src-barthes-1957` |

## Provenance

The MoMA Master Checklist (the in-repo excerpt at `src-moma-exh-0569-master-checklist`, Tier-1, covers plates 1–50 only; plate #124 falls outside that excerpt and the full PDF was not re-fetched this round) records plate #124 — per the `data/photographs.csv` notes for this row, which transcribe the checklist line:

> *"124 — U.S.S.R. — Robert Capa, LADIES' HOME JOURNAL, American — 20 × 16 3/4"*

The print dimensions (20 × 16 3/4 cm) are drawn from the `data/photographs.csv` notes for this row. The checklist carries a double credit: LADIES' HOME JOURNAL (publication) and "American" (nationality per checklist). No agency credit (such as Magnum) is listed for this plate — in contrast to other Capa plates in the exhibition where Magnum appears as the agency intermediary. The checklist's ordering places "LADIES' HOME JOURNAL" in the position where Magnum would otherwise appear, suggesting that this particular image was licensed to the exhibition through the publication directly rather than through the agency.

"U.S.S.R." is the 1955 geopolitical designation used by the checklist.

Plate #124 is the second of five Robert Capa plates in the exhibition. The five plates, in checklist order, are: plate #26 (photo-0023, Czechoslovakia, Section 3 Marriage), this plate #124 (photo-0118, USSR, Section 14 Land), plate #137 (photo-0131, USSR, Section 14 Land), plate #256 (photo-0246, USSR, Section 23 Food), and plate #285 (photo-0274, Israel, Section 24 Ring Around the Rosy). Plates #124 and #137 are consecutive within Section 14 Land in checklist numbering, separated by other photographers' plates; both are set in the USSR and carry LADIES' HOME JOURNAL credits, suggesting they derive from the same trip or assignment.

Robert Capa (1913–1954) died before the exhibition opened. The ICP Robert Capa archive (`src-icp-capa-archive`, Tier-1, in-repo, read this session) confirms his nationality as the verbatim phrase "American (b. Hungary)" and records his life-span as Budapest 1913 to Indochina 1954 (paraphrased — that exact bracketed format does not appear as a verbatim string in the source). His death — killed by a land mine on 25 May 1954 near Thai-Binh, Indochina, on LIFE assignment — is recorded in `src-nyt-1954-capa-obit` (Tier-3, in-repo, read this session; `verified: false`: the NYT archive URL returned 403 in a prior session; death date independently corroborated by `src-icp-capa-archive`). The exhibition opened on 24 January 1955; his five plates were contributed posthumously.

The `data/photographs.csv` notes observe that the Capa USSR plates "likely reference his 1947 trip with John Steinbeck (published as *A Russian Journal*, 1948)." That framing is carried from prior research work as a working hypothesis. The identification of plate #124 with the 1947 Steinbeck trip has NOT been verified against any source consulted in this round — no copy of *A Russian Journal* or its companion photographic archive was accessed. The working hypothesis is noted but not asserted.

Whether this print entered MoMA's permanent collection or was returned after the circulating tour has not been verified from any source fetched this round. Whether the print is among the Clervaux Castle holdings (CNA Luxembourg) has not been verified this round.
