# Photograph: photo-0123

| Field | Value |
|---|---|
| ID | photo-0123 |
| Title | Untitled (no title in the 1955 checklist) |
| Photographer | Brassaï (see `data/photographers.csv`) |
...
| Sources | `src-moma-exh-0569-master-checklist`; `src-wikipedia-brassai-pointer`; `src-barthes-1957`; `src-moma-archives-highlights-1955` |
...
Caption 13 — with the text attributed to a Maori source, "The land is a mother that never dies" — is recorded in the checklist as installing "by #129 and #130" (the adjacent plate #130 is David Duncan's Iranian image, photo-0124). The caption thus keyed to this Brassaï plate and its neighbor reinforces the thematic claim that land, as mother and provider, is a universal across all cultures.

Brassaï (born Gyula Halász) is recorded in `data/photographers.csv` (entry `pher-brassai`) as having six plates in the exhibition, all set in France and all credited via Rapho Guillumette agency: plates #129 (this plate, photo-0123), #203 (photo-0195), #260 (photo-0250), #296 (photo-0285), #370 (photo-0356), and #416 (photo-0403). The consistent attribution — Rapho Guillumette/French across all six plates — is fully verified against `data/photographs.csv` by grep this session. The Wikipedia article on Brassaï (`src-wikipedia-brassai-pointer`, Tier-3, in-repo, read this session) confirms: born Gyula Halász, 9 September 1899 in Brassó, Transylvania (now Brașov, Romania); died 8 July 1984 in France; naturalized French citizen 1949. The same Wikipedia article notes that "Steichen curated an exhibition of Brassaï's work at MoMA in 1956" — the year after *The Family of Man* — attesting to the close Steichen–Brassaï curatorial relationship that preceded and followed the 1955 show.

The checklist prints the photographer's name as "Brassai" without a diacritic. The canonical stage name is Brassaï (with a diaeresis-like accent), as used in his own publications including *Paris de nuit* (1933). The accent form is preserved in this note; "Brassai" is the checklist's own rendering.

Whether this large print entered MoMA's permanent collection or was returned after the circulating tour is not recorded in any source fetched this round. Whether the print is among the Clervaux Castle holdings was not verified this round.
