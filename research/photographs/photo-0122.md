...
Plate #128 is the second of eleven Henri Cartier-Bresson plates in the exhibition. The eleven plates (count verified by grep of `data/photographs.csv` this session; confirmed independently by the ICP archive record `src-icp-cartier-bresson-archive`, read this session) span multiple sections: plate #31 (photo-0028, Marriage, France), this plate #128 (photo-0122, Land, Indonesia), plate #183 (photo-0182, Woman's Work, Bali/Indonesia), plate #246 (photo-0249, Food, France), plate #288 (photo-0277, Relationships, USA), and six further plates. Cartier-Bresson's eleven plates represent one of the largest single-photographer contributions to the exhibition, alongside W. Eugene Smith (reported at a comparable count).
