# Photograph: photo-0122

| Field | Value |
|---|---|
| ID | photo-0122 |
| Title | Untitled (no title in the 1955 checklist) |
| Photographer | Henri Cartier-Bresson (see `data/photographers.csv`) |
...
| Sources | `src-moma-exh-0569-master-checklist`; `src-icp-cartier-bresson-archive`; `src-magnum-photographer-bios`; `src-wikipedia-cartier-bresson-pointer`; `src-moma-archives-highlights-1955`; `src-barthes-1957` |

## Provenance

The MoMA Master Checklist (the in-repo excerpt at `src-moma-exh-0569-master-checklist`, Tier-1, covers plates 1–50 only; plate #128 falls outside that excerpt and the full PDF was not re-fetched this round) records plate #128 — per the `data/photographs.csv` notes for this row, which transcribe the checklist line:

> *"128 — Indonesia — Henri Cartier-Bresson, Magnum, French — 48 × 69 1/4"*

The print dimensions (48 × 69 1/4 cm) are drawn from the `data/photographs.csv` notes for this row. The checklist credits Magnum (agency) and records nationality as "French." No publication credit is listed.

At 48 × 69 1/4 cm, plate #128 is a large print — notably larger than the small-format prints that dominate many of the children and family sequences. This size, approaching but not at the mural scale of the show's largest prints, indicates that Steichen or the installation designers positioned it as a visual anchor point within Section 14, Land. The MoMA Archives Highlights page (`src-moma-archives-highlights-1955`, Tier-1, in-repo, read this session) notes that installation design by Paul Rudolph used "print sizes ranging from 24 × 36 cm to 300 × 400 cm"; plate #128 sits in the upper third of this range.

Plate #128 is the second of eleven Henri Cartier-Bresson plates in the exhibition. The eleven plates (count verified by grep of `data/photographs.csv` this session; confirmed independently by the ICP archive record `src-icp-cartier-bresson-archive`, read this session) span multiple sections: plate #31 (photo-0028, Marriage, France), this plate #128 (photo-0122, Land, Indonesia), plate #190 (photo-0182, Woman's Work, Bali/Indonesia), plate #259 (photo-0249, Food, France), plate #288 (photo-0277, Relationships, USA), and six further plates. Cartier-Bresson's eleven plates represent one of the largest single-photographer contributions to the exhibition, alongside W. Eugene Smith (reported at a comparable count).

Henri Cartier-Bresson (22 August 1908 – 3 August 2004; birth/death day-month tokens from `src-wikipedia-cartier-bresson-pointer`, pointer-tier; year tokens confirmed at Tier-1 by `src-icp-cartier-bresson-archive`, both read this session). Born in Chanteloup, France. The ICP archive page (`src-icp-cartier-bresson-archive`) states verbatim: "In 1947 he co-founded the Magnum agency with Robert Capa, Chim (David Seymour), and George Rodger." The Magnum Photos directory (`src-magnum-photographer-bios`, Tier-3, in-repo, read this session) adds William Vandivert as the fifth co-founder.

That the plate is set in Indonesia (the checklist's designation) places it within Cartier-Bresson's documented presence in Asia during the late 1940s and early 1950s. Whether it was made during a specific documented journey has not been confirmed from any source fetched this round. The ICP page does not name Indonesia as a specific location for Cartier-Bresson's work.
