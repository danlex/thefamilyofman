# Photograph: photo-0013

| Field | Value |
|---|---|
| ID | photo-0013 |
| Title | Untitled (no title in the 1955 checklist) |
| Photographer | Robert Doisneau (see `data/photographers.csv`) |
...
| Sources | `src-moma-exh-0569-master-checklist`; `src-lemonde-1994-doisneau-obit`; `src-barthes-1957`; `src-moma-archives-highlights-1955` |
...
The print is small at 12 × 14 cm — among the smaller plates in Section 2 Lovers, where dimensions range from 12 × 14 cm (this plate) to 140 × 144 cm (plate #12, Dmitri Kessel). The checklist records no photograph title and no date for this print.

The Doisneau estate (`data/photographers.csv`, entry `pher-robert-doisneau`) records Doisneau's dates as April 14, 1912 – April 1, 1994, citing `src-lemonde-1994-doisneau-obit` (Tier-3, in-repo, read this session). Doisneau worked throughout his career under the Rapho Guillumette agency for distribution in the United States market, which is the credit form used by MoMA across all three of his plates in the exhibition.

Whether the print entered MoMA's permanent collection, was retained by the photographer or Rapho Guillumette, or was returned after the circulating tour is not recorded in any source fetched this round. Whether the print is among the Clervaux Castle holdings (CNA, Luxembourg) was not verified this round; the CNA collections page was not fetched this round.
