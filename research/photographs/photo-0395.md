# Photograph: photo-0395

| Field | Value |
|---|---|
| ID | photo-0395 |
| Title | Untitled (in the 1955 checklist) |
| Photographer | Henri Cartier-Bresson (see `data/photographers.csv`) |
| Year | (not recorded in checklist; likely 1948–49 — see Open questions) |
| Country of origin | China |
| Section | sec-hardship-suffering-war (Section 34, Revolt — approximate cluster fit, not canonical) |
| MoMA object ID | (not filled — MoMA collection page not fetched this round) |
| On display at Clervaux | unknown |
| Sources | `src-moma-exh-0569-master-checklist` (Tier-1, in-repo, read this session); `src-magnum-photographer-bios` (Tier-3, verified:true, fetched 2026-04-30) |

## Provenance

The MoMA Master Checklist (`src-moma-exh-0569-master-checklist`, Tier-1, in-repo, read this session) records plate #409 as: *"China — Henri Cartier-Bresson, Magnum, French — 18 x 27 1/4 cm"*. The checklist records no title, date, or subject description. The print dimensions (18 × 27 1/4 cm) make it a wide-format landscape print — larger in the horizontal dimension than Cartier-Bresson's other eight plates in the exhibition, most of which are in the 18 × 12 cm portrait range.

This is the eighth of eleven Henri Cartier-Bresson plates in the checklist, and the only one set in China. The preceding seven plates span France (×3: #31, #259, #366), Indonesia (×2: #128, #190 Bali), USA (×1: #288), and Kashmir (×1: #371); a ninth plate follows at #442 (Iran), then #481 (Java) and #483 (Spain). The geographic breadth of Cartier-Bresson's plates across the exhibition is documentable from the checklist itself.

Cartier-Bresson's co-founding role at Magnum Photos in 1947 is noted in the in-repo source file `src-magnum-photographer-bios` as part of its editorial context (Magnum's 1947 founding by Capa, Cartier-Bresson, Chim/Seymour, and Rodger is recorded in `src-icp-capa-archive` as a verbatim Tier-1 fetch). HCB's biographical dates (1908 Chanteloup, Seine-et-Marne; 2004 Provence) and his 1948–49 China assignment were **NOT verified against a primary fetch in this round** and the in-repo `src-magnum-photographer-bios` does not record these specific tokens as returned content from a fetch of the HCB-specific Magnum page. The Henri Cartier-Bresson Foundation page (https://www.henricartierbresson.org) was attempted and returned an access denial. Earlier draft of this entry incorrectly attributed the HCB biographical facts to a 2026-04-30 fetch — corrected per grounding judge on PR #94.

No CNA Clervaux collection page for this specific print was consulted this round. The Henri Cartier-Bresson Foundation page (https://www.henricartierbresson.org) was attempted and returned an access denial; its contents are not available to this session.
