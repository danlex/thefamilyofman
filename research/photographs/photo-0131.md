...
The MoMA Master Checklist (`src-moma-exh-0569-master-checklist`, Tier-1, in-repo, read this session) records plate #137 as:

> *"137 — U.S.S.R. — Robert Capa, Magnum, LADIES' HOME JOURNAL, American"*
...
The `data/photographs.csv` notes for this row observe: "The Capa-in-USSR attribution here likely references his 1947 trip with John Steinbeck (published as 'A Russian Journal,' 1948)." That framing is carried from the catalog-builder notes as context; the identification of this specific plate with the 1947 Steinbeck trip has NOT been verified against any source consulted in this round — no copy of *A Russian Journal* or its companion photographic archive was accessed. The attribution is noted as a working hypothesis, not a confirmed fact.

Robert Capa died on 25 May 1954, killed by a land mine near Thai-Binh, Indochina, on *LIFE* assignment — approximately eight months before *The Family of Man* opened at MoMA on 24 January 1955. His five plates in the exhibition were contributed posthumously. The death date and location are recorded in `src-nyt-1954-capa-obit` (Tier-3, in-repo, read this session; `verified: false` — the NYT archive URL returned 403 in a prior session and the death date was independently corroborated by `src-icp-capa-archive`, which confirms "May 25, 1954, Thai-Binh, Indochina / Vietnam" as the death location).
