# Photograph: photo-0087

| Field | Value |
|---|---|
| ID | photo-0087 |
| Title | Untitled (no title in the 1955 checklist) |
| Photographer | Dorothea Lange (see `data/photographers.csv`) |
| Year | (not recorded in checklist; not filled) |
| Country of origin | USA |
| Section | sec-family-children (Section 11 Children B) |
| MoMA object ID | (MoMA collection page not fetched this round) |
| On display at Clervaux | unknown |
| Sources | `src-moma-exh-0569-master-checklist`; `src-icp-lange-archive`; `src-wikipedia-lange-pointer`; `src-moma-archives-highlights-1955`; `src-barthes-1957` |

## Provenance

The MoMA Master Checklist (the in-repo excerpt at `src-moma-exh-0569-master-checklist`, Tier-1, covers plates 1–50 only; plate #93 falls outside that excerpt and the full PDF was not re-fetched this round) records plate #93 — per the `data/photographs.csv` notes for this row, which transcribe the checklist line:

> *"93 — U.S.A. — Dorothea Lange, American — 18 × 14 1/4"*

The print dimensions (18 × 14 1/4 cm) are taken from the `data/photographs.csv` notes for this row, which in turn draw on the Master Checklist record. No publication or agency credit is listed alongside Lange's name for this plate — the entry carries the photographer's name and nationality alone, without a LIFE, FORTUNE, or FSA institutional credit. This contrasts with other Lange plates in the exhibition that carry explicit commissioner credits: `photo-0093` (checklist #99) carries an FSA credit, and `photo-0286` and `photo-0291` (checklist entries in Section 25 Relationships) carry a FORTUNE credit.

The absence of a credit beyond "Dorothea Lange, American" for plate #93 may indicate that the image was contributed directly from Lange's own holdings or studio, rather than through a federal-program or magazine assignment. This interpretation is a working hypothesis not confirmed by any source fetched this round.

Plate #93 is the first of two Lange plates in Section 11, Children B (the second being plate #99, photo-0093). It is the fourth overall Lange plate in the checklist — the earlier entries are plate #48 (photo-0045, Section 7 Births) and two others. The plate count of nine Lange entries in the exhibition is verified by grep of `data/photographs.csv` this session; no additional source fetched this round independently enumerates the nine plates.

The print dimensions (18 × 14 1/4 cm) are modest — within the mid-range of the exhibition's print sizes, smaller than the mural-scale prints used at the show's conceptual pivots but not the smallest prints in the show. The MoMA Archives Highlights page (`src-moma-archives-highlights-1955`, Tier-1, in-repo, read this session) notes that installation design by Paul Rudolph used "print sizes ranging from 24 × 36 cm to 300 × 400 cm" — placing plate #93 below the smallest size the highlights page names, which suggests that small-format single-page prints were common in the children sequences.

Whether this print entered MoMA's permanent collection or was returned after the international circulating tour has not been established from any source fetched this round. Whether the print is among the Clervaux Castle holdings (CNA Luxembourg) has not been verified this round; no CNA collection page for this specific plate was fetched.
...
- Whether Lange's role in advising Steichen on the exhibition's selection — noted in `src-west-2025-dailyart-lange-fom` — extended to advocating for this plate has not been verified.
