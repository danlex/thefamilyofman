# Photograph: photo-0337

| Field | Value |
|---|---|
| ID | photo-0337 |
| Title | Untitled (no title in the 1955 checklist) |
| Photographer | Margaret Bourke-White (see `data/photographers.csv`) |
| Year | (not recorded in checklist; not filled) |
| Country of origin | Korea |
| Section | sec-death-mourning (Section 27 Death) |
| MoMA object ID | (MoMA collection page not fetched this round) |
| On display at Clervaux | unknown |
| Sources | `src-moma-exh-0569-master-checklist`; `src-icp-bourke-white-archive`; `src-life-archive-bourke-white-bio`; `src-wikipedia-bourke-white-pointer`; `src-moma-archives-highlights-1955`; `src-barthes-1957` |
...
The print dimensions (20 × 28 cm) are drawn from the `data/photographs.csv` notes for this row. The checklist carries a double credit: LIFE (publication) and "American" (nationality per checklist). This is consistent with all six Bourke-White plates in the exhibition, which uniformly carry "LIFE, American" credits (count and credit pattern verified by the `data/photographers.csv` entry for Bourke-White, in-repo, read this session).

The print format (20 × 28 cm — landscape orientation, given that width exceeds height) is a mid-size print for the exhibition. For comparison, Bourke-White's plate #159 (photo-0152, Section 15 Work A, USA) measures 18 × 23 cm; this Korea plate is slightly larger and in landscape rather than portrait orientation. The landscape orientation may reflect the subject matter — a horizontal compositional structure, possibly a landscape with figures — though this is inferential and has not been confirmed by any source fetched this round.

Plate #350 is the second of six Bourke-White plates in the exhibition. The six plates (count verified by grep of `data/photographs.csv` this session; confirmed by `src-icp-bourke-white-archive`, read this session) are: plate #159 (photo-0152, Work A, USA), this plate #350 (photo-0337, Death, Korea), plate #361 (photo-0348, Religious Expression, Czechoslovakia), plate #364 (photo-0350, Religious Expression, Korea), plate #380 (photo-0366, Aloneness and Compassion, India), and plate #441 (photo-0426, later sequence, South Africa). Two of the six plates are set in Korea; this is the first.

Margaret Bourke-White (1904–1971; birth/death year tokens confirmed at Tier-1 by `src-icp-bourke-white-archive`, read this session; day-month tokens from `src-wikipedia-bourke-white-pointer`, pointer-tier). The ICP archive page (`src-icp-bourke-white-archive`) states verbatim that "She was one of the first four photographers hired" for LIFE magazine in 1936, and that she "photographed major international events and stories, including Gandhi's fight for Indian independence, the unrest in South Africa, and the Korean War." The ICP page also states that she "Contracted Parkinson's disease in 1953 and made her last photo essay for *Life*, 'Megalopolis,' in 1957" — which means her Korean War coverage predated the onset of the disease, placing her Korea plates within 1950–1953. The LIFE archive page (`src-life-archive-bourke-white-bio`, Tier-3, in-repo, read this session) corroborates her LIFE founding-staff role: "That same year [1936], she became one of four original LIFE magazine photographers."

The `data/photographers.csv` note for Bourke-White observes that "India and Korea plates likely draw on her Gandhi-era reportage and her Korean War coverage respectively (general framing from her career chronology in src-life-archive-bourke-white-bio; specific plate-to-assignment matches NOT verified at the plate level)." That framing is carried here as a working hypothesis: the Korea location and the Death section placement is consistent with Korean War photojournalism, but no source fetched this round confirms that this specific plate was made during the Korean War (1950–1953) or identifies the specific setting.

Whether this print entered MoMA's permanent collection or was returned after the circulating tour has not been established from any source fetched this round. Whether the print is among the Clervaux Castle holdings (CNA Luxembourg) has not been verified this round.
...
- **Critical / theoretical (Barthes):** A Korean death image, placed in a universalizing Death section and stripped of its specific political and military context (per the CNA educational portal's observation that Steichen "took the pictures out of their context, deprived them from their title, their date or any mention about their original place" — carried from the `src-moma-exh-0569-master-checklist` notes, read this session), performs the exhibition's core operation: the historically specific suffering of a specific population is absorbed into the eternal category of human mortality.
