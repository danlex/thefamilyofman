# Photograph: photo-0032

| Field | Value |
|---|---|
| ID | photo-0032 |
| Title | Untitled (no title in the 1955 checklist) |
| Photographer | George Rodger (see `data/photographers.csv`) |
| Year | (not recorded in checklist; not filled) |
| Country of origin | Kordofan (regional designation per checklist; today central Sudan) |
...
| Sources | `src-moma-exh-0569-master-checklist`; `src-icp-rodger-archive`; `src-magnum-photographer-bios`; `src-moma-archives-highlights-1955`; `src-barthes-1957` |

## Provenance

The MoMA Master Checklist (`src-moma-exh-0569-master-checklist`, Tier-1, in-repo, read this session) records plate #35 as:

> *"35 — Kordofan — George Rodger, Magnum, British"*

The print dimension (14 × 11 cm) is recorded in `data/photographs.csv` for this row; the checklist line above does not carry print dimensions.

"Kordofan" is a region in what is today central Sudan; the checklist uses the regional rather than the national designation. In 1955 the area was part of Anglo-Egyptian Sudan, which became the independent Republic of Sudan on 1 January 1956 — the year after the exhibition opened. The ICP George Rodger archive page (`src-icp-rodger-archive`, Tier-1, in-repo, read this session) confirms that Rodger "established himself as the group's correspondent for Africa" — where "the group" refers to Magnum Photos — and "became one of the first European photographers to produce extensive reportage in Africa during the immediate postwar years." Rodger's two plates in the exhibition (this one at #35 and a second at plate #193, photo-0185) are both set in sub-Saharan Africa.

The checklist credits this plate to Magnum Photos, the cooperative agency Rodger co-founded in 1947. The ICP page (read this session) confirms: "In 1947 he joined Henri Cartier-Bresson, Robert Capa, and Chim (David Seymour) in founding the international cooperative photography agency Magnum."

No date is given in the checklist for this plate. The specific Kordofan assignment from which plate #35 was drawn has not been identified from any source fetched this round; Rodger's postwar African work spans the late 1940s and early 1950s, and no narrower window has been confirmed.
