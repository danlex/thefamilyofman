...
| Section | sec-family-children (Section 9, Children (A)) |
| MoMA object ID | (MoMA collection page not fetched this round) |
| On display at Clervaux | unknown |
| Sources | `src-moma-exh-0569-master-checklist`; `src-icp-eisenstaedt-archive`; `src-moma-archives-highlights-1955`; `src-barthes-1957` |

## Provenance

The MoMA Master Checklist (`src-moma-exh-0569-master-checklist`, Tier-1, in-repo, read this session) records plate #72 as:

> *"72 — U.S.A. — Alfred Eisenstaedt, LIFE, American"*

The print dimension (36 × 52 1/2 cm) is recorded in `data/photographs.csv` for this row; the checklist line above does not carry print dimensions.

Plate #72 is one of seven Eisenstaedt plates in the exhibition — the largest single-photographer count for any LIFE staff photographer in the show. At 36 × 52 1/2 cm, plate #72 is a mid-to-large format print, notably larger than the majority of surrounding plates in Section 9, which range from 14 × 10 3/4 cm (Clemens Kalischer, plate #75) to 36 × 52 1/2 cm (this plate). The larger format gives plate #72 visual prominence within the section's installation.

The ICP Alfred Eisenstaedt archive page (`src-icp-eisenstaedt-archive`, Tier-1, in-repo, read this session) records that "In 1936, Henry Luce hired him, along with Margaret Bourke-White, Peter Stackpole, and Thomas McAvoy as one of four staff photographers for the new LIFE magazine" and that "Eisenstaedt remained at LIFE for the next 40 years and was active as a photojournalist into his eighties." The checklist's "LIFE, American" credit for plate #72 places it squarely within Eisenstaedt's LIFE assignment work.

The ICP page (read this session) records Eisenstaedt as "Born in Dirschau (now Poland)" and gives 1898 as the birth year, 1995 as the death year. Day-month birth and death dates (December 6, 1898 and August 23, 1995) appear in the Wikipedia pointer source (`src-wikipedia-eisenstaedt-pointer`, in-repo, NOT re-fetched this round) and are carried at pointer status only.

No date is given in the checklist for plate #72. Whether the photograph was made during Eisenstaedt's prewar European period or his postwar American LIFE work has not been established from any source fetched in this round.
